...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control select2" id="category" name="category" data-placeholder="Pilih kategori"
...
<div class="mb-3 row">
    <label for="birthdate" class="col-md-2 col-form-label">Tanggal Lahir</label>
    <div class="col-md-10">
...
<div class="row justify-content-end">
    <div class="col-sm-10">
        <button type="button"
            class="btn btn-primary btnSubmit me-2">{{ @$participant ? 'Edit Data' : 'Tambah Data' }}</button>
        <a href="{{ route('apps.participant.index') }}" class="btn btn-secondary">Batal</a>
    </div>
</div>
...
@push('js')
    ...
    <script>
        ...
        @if (@$participant)
            let newOptionCourse = new Option("{{ @$participant->category->name }}", "{{ @$participant->category->id }}",
                true, true);
