...
<h4 class="fw-bold py-3 mb-4">
    ...
    <a href="{{ route('apps.pengajar.index') }}"><span class="text-muted fw-light">Pengajar /</span></a> Tambah Peserta
</h4>
    ...
    <div class="row g-3 mb-5 row-deck">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="formPengajar" action="{{ route('apps.pengajar.store') }}" method="POST">
                        @csrf
                        @include('cms.pages.pengajar.fields')
                    </form>
                </div>
            </div>
        </div>
